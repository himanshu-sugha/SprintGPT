...
const App = () => {
    ...
    if (report && report.success) {
        ...
        return (
            <Stack space="space.200">
                <Heading as="h2">🏎️ Sprint Retrospective: {metrics.sprintName || 'Sprint'}</Heading>
                ...
                <Stack space="space.100">
                    <Text>• <Strong>Velocity:</Strong> {metrics.velocity || 0} story points</Text>
                    <Text>• <Strong>Completion Rate:</Strong> {metrics.completionRate || 0}%</Text>
                    <Text>• <Strong>Avg Cycle Time:</Strong> {metrics.avgCycleTime || 0} days</Text>
                    <Text>• <Strong>Blocked Issues:</Strong> {metrics.blockedIssues || 0}</Text>
                </Stack>
                ...
                <Stack space="space.100">
                    <Text>☐ Review and address blocked items earlier</Text>
                    <Text>☐ Continue practices that maintained velocity</Text>
                </Stack>
